...
namespace Microsoft.FeatureManagement
{
    ...
    public class TargetingFeatureVariantAssigner : IFeatureVariantAssigner
    {
        ...
        /// <returns></returns>
        public async ValueTask<FeatureVariant> AssignVariantAsync(FeatureVariantAssignmentContext variantAssignmentContext)
        {
            ...
            return await _contextualResolver.AssignVariantAsync(variantAssignmentContext, targetingContext);
        }
    }
}
