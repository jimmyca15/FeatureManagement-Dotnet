...
namespace Microsoft.FeatureManagement
{
    ...
    public interface IFeatureVariantManager
    {
        ...
        ValueTask<T> GetVariantAsync<T>(string feature, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The cancellation token to cancel the operation.</param>
        /// <returns>A typed representation of the configuration variant that should be used for a given feature.</returns>
        ValueTask<T> GetVariantAsync<T, TContext>(string feature, TContext context, CancellationToken cancellationToken = default);
    }
}
